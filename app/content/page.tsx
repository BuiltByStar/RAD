    ...
    >
        ...
        <Container>
          ...
          {featured ? (
            <Link
              ...
              className="group relative grid overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-white/[.05] to-white/[.01] transition-colors hover:border-white/25 md:grid-cols-[1.1fr_0.9fr]"
            >
              ...
              <div className="flex flex-col justify-center gap-3 p-6 sm:p-8">
                ...
                <h2 className="font-[family-name:var(--font-display)] text-2xl uppercase leading-[1.05] tracking-tight text-white sm:text-3xl">
                  {featured.title}
                </h2>
          ...
          <div className="grid gap-4 sm:gap-5 md:grid-cols-2 lg:grid-cols-3">
            {feed.map((post) => (
              <Link
                ...
                className="group relative flex flex-col overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-b from-white/[.04] to-white/[0.01] transition-colors hover:border-white/25"
              >
      ...
      <Section padding="sm">
        <Container>
          ...
          <div className="mt-5 rounded-2xl border border-white/10 bg-white/[.03] p-5 sm:p-6">
