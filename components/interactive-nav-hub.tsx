...
const navNodes = [
  { label: "TEAMS", path: "/teams", position: [-3.15, 1.35, 0.45] as [number, number, number] },
  { label: "CONTENT", path: "/content", position: [3.05, 1.35, 0.45] as [number, number, number] },
  { label: "ABOUT", path: "/about", position: [-2.75, -1.25, 0.36] as [number, number, number] },
  { label: "STAFF", path: "/staff", position: [2.75, -1.2, 0.34] as [number, number, number] },
  { label: "CONTACT", path: "/contact", position: [0, -1.95, 0.62] as [number, number, number] },
];
