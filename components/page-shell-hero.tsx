      ...
      <Container size="xl">
        ...
        >
          <div className="max-w-4xl">
            ...
            {note ? (
              <motion.div
                ...
                className="mt-6 max-w-2xl rounded-md border border-white/10 bg-black/32 p-4 backdrop-blur"
              >
                {note}
              </motion.div>
            ) : null}
          ...
          <motion.div
            ...
            className="relative hidden min-h-[250px] overflow-hidden rounded-[1.25rem] border border-white/10 bg-black/36 p-6 shadow-[0_26px_80px_rgba(0,0,0,0.42)] lg:block"
          >
            ...
            />
            <div className="absolute bottom-5 left-5 right-5 flex items-center justify-between border-t border-white/10 pt-4 text-[10px] font-semibold uppercase tracking-[0.18em] text-white/42">
              <span>{meta.code}</span>
              <span>{meta.mark}</span>
            </div>
          </motion.div>
