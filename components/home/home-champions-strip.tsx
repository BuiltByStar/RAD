...
export function HomeChampionsStrip() {
  ...
  return (
    <section className="relative bg-black py-18 sm:py-24">
      <Container size="xl">
          ...
          <ol className="grid gap-4">
            {milestones.map((milestone, index) => (
              <motion.li
                ...
                className="grid gap-4 rounded-lg border border-white/10 bg-white/[0.03] p-5 sm:grid-cols-[110px_1fr] sm:p-6"
              >
                <div>
