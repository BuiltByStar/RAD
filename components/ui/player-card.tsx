        ...
        <div className="mt-auto flex flex-wrap items-center gap-2 pt-5">
          {socials.map((social) => (
            <a
              ...
              className="inline-flex items-center gap-1 rounded-md border border-white/10 bg-white/[0.03] px-2.5 py-1 text-[10px] font-semibold uppercase tracking-[0.18em] text-white/70 transition-colors hover:border-white/25 hover:text-white"
            >
              {social.label}
