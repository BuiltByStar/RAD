...
const variants: Record<Variant, string> = {
  ...
  outline:
    "border-white/24 bg-transparent text-white hover:border-white/40 hover:bg-white/[0.04]"
};
